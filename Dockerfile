...
ARG UBERBASE_POSTGREST_HOST
ARG UBERBASE_POSTGREST_PORT
ARG UBERBASE_POSTGREST_STORAGE
...
ARG UBERBASE_FUSIONAUTH_API_KEY
ARG UBERBASE_VAULT_HOST
ARG UBERBASE_VAULT_PORT
ARG UBERBASE_VAULT_STORAGE
ARG UBERBASE_TRAEFIK_STORAGE
ARG UBERBASE_TRAEFIK_HTTP_PORT
ARG UBERBASE_TRAEFIK_HTTPS_PORT
ARG UBERBASE_REGISTRY_HOST
...
ENV UBERBASE_POSTGREST_HOST $UBERBASE_POSTGREST_HOST
ENV UBERBASE_POSTGREST_PORT $UBERBASE_POSTGREST_PORT
ENV UBERBASE_POSTGREST_STORAGE $UBERBASE_POSTGREST_STORAGE
...
ENV UBERBASE_FUSIONAUTH_HOST $UBERBASE_FUSIONAUTH_HOST
...
ENV UBERBASE_FUSIONAUTH_API_KEY $UBERBASE_FUSIONAUTH_API_KEY
...
ENV UBERBASE_TRAEFIK_HTTP_PORT $UBERBASE_TRAEFIK_HTTP_PORT
ENV UBERBASE_TRAEFIK_HTTPS_PORT $UBERBASE_TRAEFIK_HTTPS_PORT
ENV UBERBASE_REGISTRY_HOST $UBERBASE_REGISTRY_HOST
...
RUN mkdir -p /home/podman/podman /home/podman/app/data
...
RUN sudo dnf install -y git postgresql-server postgresql-contrib which vim
