...
ARG UBERBASE_LOGTO_HOST
ARG UBERBASE_LOGTO_PUBLIC_PORT
ARG UBERBASE_LOGTO_ADMIN_PORT
ARG UBERBASE_LOGTO_DATABASE
ARG UBERBASE_LOGTO_ENDPOINT
ARG UBERBASE_LOGTO_ADMIN_ENDPOINT
...
ENV UBERBASE_LOGTO_HOST $UBERBASE_LOGTO_HOST
ENV UBERBASE_LOGTO_PUBLIC_PORT $UBERBASE_LOGTO_PUBLIC_PORT
ENV UBERBASE_LOGTO_ADMIN_PORT $UBERBASE_LOGTO_ADMIN_PORT
ENV UBERBASE_LOGTO_DATABASE $UBERBASE_LOGTO_DATABASE
ENV UBERBASE_LOGTO_ENDPOINT $UBERBASE_LOGTO_ENDPOINT
ENV UBERBASE_LOGTO_ADMIN_ENDPOINT $UBERBASE_LOGTO_ADMIN_ENDPOINT
